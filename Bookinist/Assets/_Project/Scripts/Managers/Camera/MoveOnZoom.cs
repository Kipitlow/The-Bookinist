...
public class MoveOnZoom : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _startingLocalPosition = _baseLocalPosition + new Vector3(
        ...
        _moveObject.SetPositionImmediate(_startingLocalPosition);
    ...
    private void StartShowingAtBeginning()
    {
        ...
        _currentAlpha = 0f;
        _moveObject.MoveTo(_baseLocalPosition, 0.01f);
    }

    private void StartShowing()
    {
        _state = ZoomState.Showing;
        _moveObject.MoveTo(_baseLocalPosition, _smoothTime);
    ...
    {
        _state = ZoomState.Showing;
        _moveObject.MoveTo(_baseLocalPosition, 0f);
    }
    ...
    {
        if (_state == ZoomState.Showing && _moveObject.IsAtPosition(_baseLocalPosition))
        {
    ...
    {
        _state = ZoomState.Visible;
        _moveObject.SetPositionImmediate(_baseLocalPosition);
