...
//     version 1.14.0
//     from Assets/_Project/Scripts/Gameplay/Controls/InputSystem_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Project/Scripts/Gameplay/Controls/InputSystem_Actions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Zoom"",
                    ""type"": ""Value"",
                    ""id"": ""beb2c3fe-c872-4510-85c0-ef254b95af3f"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""df70a130-ad23-4c44-a3a1-e5a923013451"",
                    ""path"": ""<Pointer>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // LevelNav
        m_LevelNav = asset.FindActionMap("LevelNav", throwIfNotFound: true);
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_LevelNav.enabled, "This will cause a leak and performance issues, InputSystem_Actions.LevelNav.Disable() has not been called.");
    ...
    // LevelNav
    private readonly InputActionMap m_LevelNav;
    private List<ILevelNavActions> m_LevelNavActionsCallbackInterfaces = new List<ILevelNavActions>();
    ...
    public struct LevelNavActions
    {
        ...
        /// </summary>
        public LevelNavActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "LevelNav/Drag".
        /// </summary>
        public InputAction @Drag => m_Wrapper.m_LevelNav_Drag;
        /// <summary>
        /// Provides access to the underlying input action "LevelNav/DragPress".
        /// </summary>
        public InputAction @DragPress => m_Wrapper.m_LevelNav_DragPress;
        /// <summary>
        ...
        /// </summary>
        public InputAction @Position => m_Wrapper.m_LevelNav_Position;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_LevelNav; }
        ...
        /// <summary>
        /// Implicitly converts an <see ref="LevelNavActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(LevelNavActions set) { return set.Get(); }
        /// <summary>
        ...
        /// </remarks>
        /// <seealso cref="LevelNavActions" />
        public void AddCallbacks(ILevelNavActions instance)
        {
            if (instance == null || m_Wrapper.m_LevelNavActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_LevelNavActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="LevelNavActions" />
        private void UnregisterCallbacks(ILevelNavActions instance)
        {
            @Drag.started -= instance.OnDrag;
            @Drag.performed -= instance.OnDrag;
            @Drag.canceled -= instance.OnDrag;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="LevelNavActions.UnregisterCallbacks(ILevelNavActions)" />.
        /// </summary>
        /// <seealso cref="LevelNavActions.UnregisterCallbacks(ILevelNavActions)" />
        public void RemoveCallbacks(ILevelNavActions instance)
        {
            if (m_Wrapper.m_LevelNavActionsCallbackInterfaces.Remove(instance))
        ...
        /// </remarks>
        /// <seealso cref="LevelNavActions.AddCallbacks(ILevelNavActions)" />
        /// <seealso cref="LevelNavActions.RemoveCallbacks(ILevelNavActions)" />
        /// <seealso cref="LevelNavActions.UnregisterCallbacks(ILevelNavActions)" />
        public void SetCallbacks(ILevelNavActions instance)
        {
            foreach (var item in m_Wrapper.m_LevelNavActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_LevelNavActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="LevelNavActions" /> instance referencing this action map.
    /// </summary>
    public LevelNavActions @LevelNav => new LevelNavActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "LevelNav" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="LevelNavActions.AddCallbacks(ILevelNavActions)" />
    /// <seealso cref="LevelNavActions.RemoveCallbacks(ILevelNavActions)" />
    public interface ILevelNavActions
    {
        /// <summary>
        ...
        /// <summary>
        /// Method invoked when associated input action "DragPress" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
